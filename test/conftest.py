...
def notebooks():
    ...
    paths = {
        ...
        "text_classification_mnli_bow_lr": os.path.join(folder_notebooks, "text_classification",
                                                        "text_classification_mnli_bow_lr.ipynb"),
        "text_classification_sst2_three_player": os.path.join(folder_notebooks, "text_classification",
                                                              "text_classification_sst2_three_player.ipynb")
    }
    return paths
